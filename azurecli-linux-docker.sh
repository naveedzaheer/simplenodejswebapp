...
export APP_PE_DEMO_RG=nz007lindock-pedemo-rg
export LOCATION=eastus2  
export DEMO_VNET=nz007lindock-pedemo-vnet
...
export DEMO_APP_PLAN=nz007lindock-app-plan
export DEMO_APP_NAME=nz007lindock-simplenode-app
export DEMO_WEB_APP_NAME=simplenodewebapp

export DEMO_APP_VM=pldemovmlin
...
export DEMO_APP_KV=nz007lindock-demo-kv-03
export DEMO_APP_ACR=nz007lindockacr
...
az acr build -t $DEMO_WEB_APP_NAME":{{.Run.ID}}" -r $DEMO_APP_ACR .
export CONTAINER_IMAGE_NAME=nz007lindockacr.azurecr.io/simplenodewebapp:ch2

# Create App Service Plan
az appservice plan create -g $APP_PE_DEMO_RG -l $LOCATION -n $DEMO_APP_PLAN \
   --is-linux --number-of-workers 1 --sku P1V2

# Create Node JS Web App from container
az webapp create -g $APP_PE_DEMO_RG -p $DEMO_APP_PLAN -n $DEMO_APP_NAME -i $CONTAINER_IMAGE_NAME \
    -s <UserId from ACR> -w <Password from ACR>

# "enabledHostNames": [
#    "nz007lindock-simplenode-app.azurewebsites.net",
#    "nz007lindock-simplenode-app.scm.azurewebsites.net"
#  ]
...
export APP_MSI="e49607a4-2ac8-46bd-9b60-ff63d3f1f6ff"

# Create Key Vault
az keyvault create --location $LOCATION --name $DEMO_APP_KV --resource-group $APP_PE_DEMO_RG

export KV_URI="/subscriptions/03228871-7f68-4594-b208-2d8207a65428/resourceGroups/nz007lindock-pedemo-rg/providers/Microsoft.KeyVault/vaults/nz007lindock-demo-kv-03"
...
export WEB_APP_RESOURCE_ID="/subscriptions/03228871-7f68-4594-b208-2d8207a65428/resourceGroups/nz007lindock-pedemo-rg/providers/Microsoft.Web/sites/nz007lindock-simplenode-app"
